...
public class RedJUtils implements UtilsComponent {
	...
	@Override
	public  AbsolutePath<T> newAbsolutePath (final T mount_point) {
	...
	@Override
	public AbsolutePath<T> newAbsolutePath (final T mount_point, final RelativePath relative) {
	...
	@Override
	public  StateSwitcher<T> newStateSwitcher (final T default_state) {
...
//	@Override
//	public  Set<T> intersectCollections (final Collection<T> listA, final Collection<T> listB) {
