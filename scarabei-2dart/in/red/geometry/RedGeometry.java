...
public class RedGeometry implements GeometryComponent {
	...
	@Override
	public void setPointsCollectionSize (final EditableCollection<T> a, final int size) {
		if (a.size() == size) {
			return;
		}
		if (a.size() < size) {
...
//	}
	...
	@Override
	public Rectangle setupWrapingFrame (final Collection<ReadOnlyFloat2> points_to_wrap,
	...
	@Override
	public  T newFloat3 (final T target_list, final int how_many_to_add) {
	...
	@Override
	public T newFloat2 (final T target_list, final int how_many_to_add) {
		Debug.checkNull("target_list", target_list);
		for (int i = 0; i < how_many_to_add; i++) {
