...
public class RedSpline2D implements Spline2D {
	final CollectionConverter<ReadOnlyFloat2, Vec3D> converter = new RED_SPLINE_CONVERTER(); 
//		new CollectionConverter<ReadOnlyFloat2, Vec3D>() {
//
//		@Override
...
//	};
	...
	@Override
	public void computeSpline (final Collection<ReadOnlyFloat2> input, final int resolution) {
		final EditableCollection<Vec3D> O = Collections.newList();
		final Collection<ReadOnlyFloat2> I = input;
