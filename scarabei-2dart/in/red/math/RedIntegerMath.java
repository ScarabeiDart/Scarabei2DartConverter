...
public class RedIntegerMath implements IntegerMathComponent {
	...
	static {
		...
		LONG_MASKS[0] = 0x00000000000000ff;
		LONG_MASKS[1] = 0x000000000000ff00;
		LONG_MASKS[2] = 0x0000000000ff0000;
		LONG_MASKS[3] = 0x00000000ff000000;
		LONG_MASKS[4] = 0x000000ff00000000;
		LONG_MASKS[5] = 0x0000ff0000000000;
		LONG_MASKS[6] = 0x00ff000000000000;
		LONG_MASKS[7] = 0xff00000000000000;
	}
	...
	public int decomposeInteger (final long input_alue, final int byte_position) {
		final int byte_value = (int)((input_alue >> (8 * byte_position)) & 0x00000000000000ff);
		return byte_value;
	}
