...
// private final int code = -1;
	...
	@Override
	public Mapping<String, Collection> getResponseHeaders () throws IOException {
		this.state.expectState(CONNECTION_STATE.OPEN);
		if (this.java_connection == null) {
			this.tryToOpenConnection();
		}
		final Map<String, Collection> fields = this.wrapMap(this.java_connection.getHeaderFields());
// fields.print("HeaderFields");
// return this.java_connection.getHeaderField(key);
		return fields;
	}

//	private Map<String, Collection> wrapMap (final java.util.Map<String, java.util.List<String>> headerFields) {
//		final Map<String, Collection> result = Collections.newMap();
