...
public class RedArrayColorMap implements ArrayColorMap {
	...
	final private ColoredLambdaImage COLORED = new COLORED();
//		new ColoredLambdaImage() {
//		@Override
...
//	};
	...
	final private EditableGrayMap alpha = new ALPHA();
//		new EditableGrayMap() {
//
//		@Override
//		public int getWidth () {
...
//	};
	...
	final private EditableGrayMap red = new RED();
...
//	};
	...
	final private EditableGrayMap green = new GREEN();
...
//	};
	...
	final private EditableGrayMap blue = new BLUE();
//	new EditableGrayMap() {
//
//		@Override
//		public int getWidth () {
