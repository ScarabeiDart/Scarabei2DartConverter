...
public interface GeometryComponent {
	...
	public boolean equalPointCollections (Collection<ReadOnlyFloat2> a, Collection<ReadOnlyFloat2> b);

	public  void setPointsCollectionSize (EditableCollection<T> a, int size);

	public void copyValues (Collection<ReadOnlyFloat2> a, EditableCollection<Float2> b);

	public void copyValues (Collection<ReadOnlyFloat2> a, EditableCollection<Float2> b, int offset);

	public void applyTransformation (Matrix transformation, EditableCollection<Float2> points_to_process);
	...
	public Rectangle setupWrapingFrame (Collection<ReadOnlyFloat2> points_to_wrap, Rectangle wrapping_frame);

	public Float3 newFloat3 (double x, double y, double z);

	public Float3 newFloat3 ();

//	public <EditableCollection<Float3>> T newFloat3 (T target_list, int how_many_to_add);
//
//	public <EditableCollection<Float2>> T newFloat2 (T target_list, int how_many_to_add);
