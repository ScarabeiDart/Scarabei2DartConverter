...
public class Geometry {
	...
	public static boolean equalFloat2Collections (final Collection<ReadOnlyFloat2> A,
		final Collection<ReadOnlyFloat2> B) {
...
//	}
	...
	public static void copyValues (final Collection<ReadOnlyFloat2> A, final EditableCollection<Float2> B) {
	...
	public static void applyTransformation (final Matrix transformation,
		final EditableCollection<Float2> points_to_process) {
	...
	public static Rectangle setupWrapingFrame (final Collection<ReadOnlyFloat2> points_to_wrap,
...
// public static <T extends LinearCombinable<T, T>> BezierPoint<T> newBezierPoint (final T base) {
