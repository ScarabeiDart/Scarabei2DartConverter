...
public interface UtilsComponent {
	...
	RelativePath newRelativePath ();
	 ...
	 AbsolutePath<T> newAbsolutePath (T mount_point, RelativePath relative);

	 AbsolutePath<T> newAbsolutePath (T mount_point);

    StateSwitcher<T> newStateSwitcher (T default_state);
